...
const policyHtml = `
    ...
    <ul>
        <li><span>Visit our website at <a href="https://firecms.co"
                                          target="_blank">https://firecms.co</a><span> or <a href="https://app.dataki.ai"
                                          target="_blank">https://app.dataki.ai</a><span>, or any website of ours that links to this privacy notice</span></span>
        </li>
    </ul>
    <div>
        ...
        <div><br></div>
        <div><span><strong>What personal information do we process?</strong> When you visit, use, or navigate our Services, we may process personal information depending on how you interact with Dataki and the Services, the choices you make, and the products and features you use. Click&nbsp;</span><a><span>here</span></a><span>&nbsp;to learn more.</span>
        </div>
        <div><br></div>
        <div>
        ...
        <div><br></div>
        <div><span>Want to learn more about what Dataki does with any information we collect? Click&nbsp;</span><a><span>here</span></a><span>&nbsp;to review the notice in full.</span>
        </div>
        <div><br></div>
        <div><br></div>
                                                                    ...
                                                                    <div>
                                                                        ...
                                                                        <ul>
                                                                            ...
                                                                            <li>
                                                                                ...
                                                                                <span>When using the online service Dataki. </span>
                                                                                <span>Dataki use and transfer to any other app of information received from Google APIs will adhere to <a
                                                                                        target="_blank"
